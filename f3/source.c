...
void enc_s01_n02(uint8_t * inputb, uint8_t * key,uint8_t * outputb );
...
void bs_expand_key(word_t (* rk)[128], uint8_t * key);
void bs_cipher(word_t state[128], word_t (* rk)[128]);
void bs_cipher_rev(word_t state[128], word_t (* rk)[128]);
